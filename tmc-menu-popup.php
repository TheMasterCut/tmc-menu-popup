...
$checkWP    = $requirementChecker->checkWPVersion( '5', 'Menu Popup TMC mode requires WP version >= 5' );
...
App::initShellPress( __FILE__, 'tmc_mp', '1.0.3' );   //  <--- Remember to always change version here
